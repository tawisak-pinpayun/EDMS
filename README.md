...
> **Import mode ปัจจุบันเป็น Upsert:** เมื่อตรวจสอบไฟล์ผ่าน ระบบจะใช้ `employeeId` เป็นเงื่อนไขในการอัปเดต/เพิ่มข้อมูลผ่าน `bulkWrite` โดยไม่ลบข้อมูลเดิมที่ไม่ได้อยู่ในไฟล์ที่นำเข้า หาก `employeeId` ตรงกับข้อมูลเดิมจะอัปเดตค่าตามไฟล์ใหม่ หากไม่ตรงจะเพิ่มเป็นข้อมูลใหม่
